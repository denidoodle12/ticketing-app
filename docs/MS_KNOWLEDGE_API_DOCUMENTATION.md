...
| Role | Level | GET List | GET Detail | POST | PUT | DELETE |
|------|-------|----------|------------|------|-----|--------|
| Customer | 1 | ✅ (published + visibility=all) | ✅ | ❌ | ❌ | ❌ |
| Agent | 2 | ✅ (published + visibility ≠ admin_only) | ✅ | ❌ | ❌ | ❌ |
| Admin | 5 | ✅ (semua status & visibility) | ✅ | ✅ | ✅ | ✅ |
| Super Admin | 10 | ❌ (tenant-scoped) | ❌ | ❌ | ❌ | ❌ |
